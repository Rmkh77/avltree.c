...
struct node* deleteNode(struct node *root, int key)
{
    ...
    if( (root->left == NULL) ||(root->right == NULL) )
    {
        ...
        root = NULL;
            ...
            *root = *temp; // Copy the contents of the non-empty child free(temp);
    }
    else
    {
    ...
    do{
        ...
        switch(choice)
        {
            ...
            case 2 : printf("enter number to delete :");
                     ...
                     break;
            case 3 : printf("Preorder traversal of the constructed AVL tree is :\n");
                     preOrder(root);
                     break;
            case 4 :  root->height = 1 + max(height(root->left),height(root->right));
                     printf("height of the constructed AVL tree is : %d",root->height);
                     break;
            case 0 : break;
        }
    }while(choice != NULL);
